...
export default function Footer() {
  return (
    <footer className="bg-[#3a6a34] text-white pt-8 pb-6 px-6 sm:px-10 lg:px-16 rounded-t-2xl md:rounded-t-3xl mt-auto">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-6 items-center">
        ...
        <div className="flex justify-center md:justify-start items-center">
          <div className="bg-white w-24 h-24 md:w-28 md:h-28 rounded-full flex flex-col items-center justify-center p-1 shadow-lg">
            <span className="text-[#3a6a34] text-3xl md:text-4xl font-bold">
              HH
            </span>
            <span className="text-[#3a6a34] text-[10px] md:text-xs uppercase tracking-wide">
              Hospital
            </span>
          </div>
        </div>
        ...
        <div className="text-center md:text-center">
          ...
          <p className="text-xs sm:text-sm md:text-base mb-0.5 sm:mb-1">
            Building - 5, Road - 10
          </p>
